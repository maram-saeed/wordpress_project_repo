...
?>
	...
	<div id="content" class="site-content">
		<div class="container">
			...
			<?php bosa_portfolio_resume_blog_advertisement_banner(); ?>
			...
			<?php get_template_part( 'template-parts/featured-categories/featured-categories' ); ?>
							...
							<?php
								if( !get_theme_mod( 'disable_pagination', false ) ):
									the_posts_pagination( array(
										...
										'next_text' => '<span>'.esc_html__( 'Next', 'bosa-portfolio-resume' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'bosa-portfolio-resume' ) . '</span>',
										'prev_text' => '<span>'.esc_html__( 'Prev', 'bosa-portfolio-resume' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'bosa-portfolio-resume' ) . '</span>',
										'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'bosa-portfolio-resume' ) . ' </span>',
									));
								endif;
								wp_reset_postdata();
							?>
