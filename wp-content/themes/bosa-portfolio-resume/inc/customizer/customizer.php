 ...
 */
add_action( 'customize_preview_init', 'bosa_portfolio_resume_customize_preview_js', 999, 1 );

function bosa_portfolio_resume_customize_preview_js() {
	wp_enqueue_script( 'bosa-portfolio-resume-customizer', get_stylesheet_directory_uri() . '/inc/customizer/customizer.js', array( 'customize-preview' ) );
}

function bosa_portfolio_resume_customize_getting_js() {
	wp_dequeue_script( 'bosa-customizer-getting-started' );
	wp_enqueue_script( 'bosa-portfolio-resume-customizer-getting-started', get_stylesheet_directory_uri() . '/inc/getting-started/getting-started.js', array( 'customize-controls', 'jquery' ), true );

	wp_enqueue_style( 'bosa-portfolio-resume-customize-controls', get_stylesheet_directory_uri() . '/inc/customizer/customizer.css' );
}
add_action( 'customize_controls_enqueue_scripts', 'bosa_portfolio_resume_customize_getting_js', 99 );
 ...
 * @return void
 */
add_action( 'init' , 'bosa_portfolio_resume_kirki_fields', 999, 1 );

function bosa_portfolio_resume_kirki_fields(){
	...
	*/
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Site Title', 'bosa-portfolio-resume' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Site Description', 'bosa-portfolio-resume' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Main Menu', 'bosa-portfolio-resume' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Main Menu Description', 'bosa-portfolio-resume' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Body', 'bosa-portfolio-resume' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'General Title (H1 - H6)', 'bosa-portfolio-resume' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Page & Single Post Title', 'bosa-portfolio-resume' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Title Typography', 'bosa-portfolio-resume' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Category Typography', 'bosa-portfolio-resume' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Meta Typography', 'bosa-portfolio-resume' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Excerpt Typography', 'bosa-portfolio-resume' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Slider Button Typography', 'bosa-portfolio-resume' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Content Alignment', 'bosa-portfolio-resume' ),
		'type'        => 'select',
		'settings'    => 'main_slider_content_alignment',
		'section'     => 'main_slider_options',
		'default'     => 'left',
		'choices'  => array(
			'center' => esc_html__( 'Center', 'bosa-portfolio-resume' ),
			'left'   => esc_html__( 'Left', 'bosa-portfolio-resume' ),
			'right'  => esc_html__( 'Right', 'bosa-portfolio-resume' ),
		),
		'priority'	  =>  180,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Section Title Typography', 'bosa-portfolio-resume' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Section Description Typography', 'bosa-portfolio-resume' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Title Typography', 'bosa-portfolio-resume' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Category Typography', 'bosa-portfolio-resume' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Meta Typography', 'bosa-portfolio-resume' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Excerpt Typography', 'bosa-portfolio-resume' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Widget Title Typography', 'bosa-portfolio-resume' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Header Height (in px)', 'bosa-portfolio-resume' ),
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Footer Layouts', 'bosa-portfolio-resume' ),
		'type'        => 'radio-image',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Bottom Footer Typography', 'bosa-portfolio-resume' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Select Image', 'bosa-portfolio-resume' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'    => esc_html__( 'Image Link', 'bosa-portfolio-resume' ),
		'type'     => 'link',
	...
	Kirki::add_field( 'bosa', array(
		'label'    => esc_html__( 'Image Target', 'bosa-portfolio-resume' ),
		'description' => esc_html__( 'If enabled, the page will be open in an another browser tab.', 'bosa-portfolio-resume' ),
		'type'     => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Image Width', 'bosa-portfolio-resume' ),
		'type'         => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Section Border', 'bosa-portfolio-resume' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'feature_posts_options', array(
	    'title'          => esc_html__( 'Featured Posts / Pages', 'bosa-portfolio-resume' ),
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Featured Posts / Pages', 'bosa-portfolio-resume' ),
		...
		'priority'    => '9',
		'choices'  => array(
			'featured_posts' => esc_html__( 'Featured Posts', 'bosa-portfolio-resume' ),
			'featured_pages' => esc_html__( 'Featured Pages', 'bosa-portfolio-resume' ),
		)
	) );

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Posts Section', 'bosa-portfolio-resume' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Section Title', 'bosa-portfolio-resume' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Section Title', 'bosa-portfolio-resume' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Section Description', 'bosa-portfolio-resume' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Section Description', 'bosa-portfolio-resume' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Section Title and Description Alignment', 'bosa-portfolio-resume' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Section Layout', 'bosa-portfolio-resume' ),
		'description' => esc_html__( 'Select layout & scroll below to change its options', 'bosa-portfolio-resume' ),
		'type'        => 'radio-image',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Title Color', 'bosa-portfolio-resume' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Category Background Color', 'bosa-portfolio-resume' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Category Color', 'bosa-portfolio-resume' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Meta Text Color', 'bosa-portfolio-resume' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Meta Icon Color', 'bosa-portfolio-resume' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Hover Color', 'bosa-portfolio-resume' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Columns', 'bosa-portfolio-resume' ),
		'type'        => 'select',
		'settings'    => 'feature_posts_columns',
		'section'     => 'feature_posts_options',
		'default'     => 'three_columns',
		'placeholder' => esc_attr__( 'Select category', 'bosa-portfolio-resume' ),
		'choices'  => array(
			'one_column'    => esc_html__( '1 Column', 'bosa-portfolio-resume' ),
			'two_columns'   => esc_html__( '2 Columns', 'bosa-portfolio-resume' ),
			'three_columns' => esc_html__( '3 Columns', 'bosa-portfolio-resume' ),
			'four_columns'  => esc_html__( '4 Columns', 'bosa-portfolio-resume' ),
		),
		'priority'	  =>  160,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Choose Category', 'bosa-portfolio-resume' ),
		'description' => esc_html__( 'Recent posts will show if any category is not chosen.', 'bosa-portfolio-resume' ),
		'type'        => 'select',
		'settings'    => 'feature_posts_category',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'placeholder' => esc_html__( 'Select category', 'bosa-portfolio-resume' ), 
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Featured Posts Overlay Opacity', 'bosa-portfolio-resume' ),
		'type'        => 'number',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post View Number', 'bosa-portfolio-resume' ),
		'description'  => esc_html__( 'Number of posts to show.', 'bosa-portfolio-resume' ),
		'type'         => 'number',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Height (in px)', 'bosa-portfolio-resume' ),
		'description'  => esc_html__( 'This option will only apply to Desktop. Please click on below Desktop Icon to see changes. Automatically adjust by theme default in the responsive devices.
		', 'bosa-portfolio-resume' ),
		'type'         => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Choose Image Size', 'bosa-portfolio-resume' ),
		'type'        => 'select',
		'settings'    => 'render_feature_post_image_size',
		'section'     => 'feature_posts_options',
		'default'     => 'bosa-420-300',
		'placeholder' => esc_html__( 'Select Image Size', 'bosa-portfolio-resume' ),
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Background Image Size', 'bosa-portfolio-resume' ),
		'type'         => 'radio',
		'settings'     => 'feature_posts_image_size',
		'section'      => 'feature_posts_options',
		'default'      => 'cover',
		'choices'      => array(
			'cover'    => esc_html__( 'Cover', 'bosa-portfolio-resume' ),
			'pattern'  => esc_html__( 'Pattern / Repeat', 'bosa-portfolio-resume' ),
			'norepeat' => esc_html__( 'No Repeat', 'bosa-portfolio-resume' ),
		),
		'priority'	   =>  220,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Posts Border Radius (px)', 'bosa-portfolio-resume' ),
		'type'        => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Text Alignment', 'bosa-portfolio-resume' ),
		'type'        => 'select',
		'settings'    => 'feature_posts_text_alignment',
		'section'     => 'feature_posts_options',
		'default'     => 'text-left',
		'choices'     => array(
			'text-left'	 	=> esc_html__( 'Left', 'bosa-portfolio-resume' ),
			'text-center'  	=> esc_html__( 'Center', 'bosa-portfolio-resume' ),   
			'text-right'	=> esc_html__( 'Right', 'bosa-portfolio-resume' ),
		),
		'priority'	  =>  240,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Content Alignment', 'bosa-portfolio-resume' ),
		'type'        => 'select',
		'settings'    => 'feature_posts_title_alignment',
		'section'     => 'feature_posts_options',
		'default'     => 'align-bottom',
		'choices'     => array(
			'align-top'	 	=> esc_html__( 'Top', 'bosa-portfolio-resume' ),
			'align-center'  => esc_html__( 'Center', 'bosa-portfolio-resume' ),   
			'align-bottom'  => esc_html__( 'Bottom', 'bosa-portfolio-resume' ),
		),
		'priority'	  =>  250,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Title', 'bosa-portfolio-resume' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Title Divider', 'bosa-portfolio-resume' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Posts category', 'bosa-portfolio-resume' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Date', 'bosa-portfolio-resume' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Author', 'bosa-portfolio-resume' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Comment', 'bosa-portfolio-resume' ),
		'type'        => 'checkbox',
	...
	// featured pages
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Pages Section', 'bosa-portfolio-resume' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 1', 'bosa-portfolio-resume' ),
		'type'        => 'select',
		'settings'    => 'featured_pages_one',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Page 1', 'bosa-portfolio-resume' ),
		'choices'     => bosa_portfolio_resume_get_pages(),
		'priority'	  => 450,
		'active_callback' => array(
			array(
				'setting'  => 'feature_posts_pages_tab',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 2', 'bosa-portfolio-resume' ),
		'type'        => 'select',
		'settings'    => 'featured_pages_two',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Page 2', 'bosa-portfolio-resume' ),
		'choices'     => bosa_portfolio_resume_get_pages(),
		'priority'	  => 460,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 3', 'bosa-portfolio-resume' ),
		'type'        => 'select',
		'settings'    => 'featured_pages_three',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'choices'     => bosa_portfolio_resume_get_pages(),
		'placeholder' => esc_html__( 'Select Page 3', 'bosa-portfolio-resume' ),
		'priority'	  => 470,
		'active_callback' => array(
			array(
				'setting'  => 'feature_posts_pages_tab',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 4', 'bosa-portfolio-resume' ),
		'type'        => 'select',
		'settings'    => 'featured_pages_four',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'choices'     => bosa_portfolio_resume_get_pages(),
		'placeholder' => esc_html__( 'Select Page 4', 'bosa-portfolio-resume' ),
		'priority'	  => 480,
		'active_callback' => array(
			array(
				'setting'  => 'feature_posts_pages_tab',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Featured Page Overlay Opacity', 'bosa-portfolio-resume' ),
		'type'        => 'number',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page Border Radius (px)', 'bosa-portfolio-resume' ),
		'type'        => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Page Title', 'bosa-portfolio-resume' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Page Title Color', 'bosa-portfolio-resume' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Page Hover Color', 'bosa-portfolio-resume' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page Title Horizontal Alignment', 'bosa-portfolio-resume' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page Title Vertical Alignment', 'bosa-portfolio-resume' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Page Title Typography', 'bosa-portfolio-resume' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Posts / Pages', 'bosa-portfolio-resume' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'blog_advert_banner_options', array(
	    'title'          => esc_html__( 'Blog Advertisement Banner', 'bosa-portfolio-resume' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => '22',
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Advertisement Banner', 'bosa-portfolio-resume' ),
		'description'  => esc_html__( 'Image dimensions 1230 by 100 pixels is recommended.', 'bosa-portfolio-resume' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'    => esc_html__( 'Advertisement Banner Link', 'bosa-portfolio-resume' ),
		'type'     => 'link',
	...
	Kirki::add_field( 'bosa', array(
		'label'    		=> esc_html__( 'Advertisement Banner Target', 'bosa-portfolio-resume' ),
		'description' 	=> esc_html__( 'If enabled, the page will be open in an another browser tab.', 'bosa-portfolio-resume' ),
		'type'     		=> 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Advertisement Banner', 'bosa-portfolio-resume' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'feature_posts_two_options', array(
	    'title'          => esc_html__( 'Featured Posts Two', 'bosa-portfolio-resume' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 24,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Posts Two Section', 'bosa-portfolio-resume' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Posts Overlay Opacity', 'bosa-portfolio-resume' ),
		'type'        => 'number',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Content Horizontal Alignment', 'bosa-portfolio-resume' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Content Vertical Alignment', 'bosa-portfolio-resume' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Posts Two', 'bosa-portfolio-resume' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Layouts', 'bosa-portfolio-resume' ),
		'description' => esc_html__( 'Grid / List / Single/ Grid Thumbnail', 'bosa-portfolio-resume' ),
		'type'        => 'radio-image',
	...
	Kirki::add_field( 'bosa', array(
	    ...
	    'section'     => 'blog_page_style_options',
	    'default'     => esc_html__( 'Thumbnail Post Options', 'bosa-portfolio-resume' ),
	    'priority'	  => 300,
	    'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Choose Image Size', 'bosa-portfolio-resume' ),
		'description' => esc_html__( 'Image Size for thumbnail post only.', 'bosa-portfolio-resume' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Border Radius (px)', 'bosa-portfolio-resume' ),
		'description' => esc_html__( 'Post Border Radius for thumbnail post only.', 'bosa-portfolio-resume' ),
		'type'        => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Date', 'bosa-portfolio-resume' ),
		'description'  => esc_html__( 'Disables date for thumbnail post only.', 'bosa-portfolio-resume' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Author', 'bosa-portfolio-resume' ),
		'description'  => esc_html__( 'Disables author for thumbnail post only.', 'bosa-portfolio-resume' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Comment Link', 'bosa-portfolio-resume' ),
		'description'  => esc_html__( 'Disables comment link for thumbnail post only.', 'bosa-portfolio-resume' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Excerpt', 'bosa-portfolio-resume' ),
		'description'  => esc_html__( 'Disables excerpt for thumbnail post only.', 'bosa-portfolio-resume' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Post Button', 'bosa-portfolio-resume' ),
		'description'  => esc_html__( 'Disables button for thumbnail post only.', 'bosa-portfolio-resume' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'blog_services', array(
	    'title'          => esc_html__( 'Services', 'bosa-portfolio-resume' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 26,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Services Section', 'bosa-portfolio-resume' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Services', 'bosa-portfolio-resume' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'blog_featured_categories', array(
	    'title'          => esc_html__( 'Featured Categories', 'bosa-portfolio-resume' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 27,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Categories Section', 'bosa-portfolio-resume' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Category One', 'bosa-portfolio-resume' ),
		'type'        => 'select',
		'settings'    => 'featured_category_one',
		'section'     => 'blog_featured_categories',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Category One', 'bosa-portfolio-resume' ),
		'choices'     => bosa_get_post_categories(),
		'priority'	  => 20,
	));

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Category One Image', 'bosa-portfolio-resume' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Category Two', 'bosa-portfolio-resume' ),
		'type'        => 'select',
		'settings'    => 'featured_category_two',
		'section'     => 'blog_featured_categories',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Category Two', 'bosa-portfolio-resume' ),
		'choices'     => bosa_get_post_categories(),
		'priority'	  => 40,
	));

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Category Two Image', 'bosa-portfolio-resume' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Category Three', 'bosa-portfolio-resume' ),
		'type'        => 'select',
		'settings'    => 'featured_category_three',
		'section'     => 'blog_featured_categories',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Category Three', 'bosa-portfolio-resume' ),
		'choices'     => bosa_get_post_categories(),
		'priority'	  => 60,
	));

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Category Three Image', 'bosa-portfolio-resume' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Category Four', 'bosa-portfolio-resume' ),
		'type'        => 'select',
		'settings'    => 'featured_category_four',
		'section'     => 'blog_featured_categories',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Category Four', 'bosa-portfolio-resume' ),
		'choices'     => bosa_get_post_categories(),
		'priority'	  => 80,
	));

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Category Four Image', 'bosa-portfolio-resume' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Category Five', 'bosa-portfolio-resume' ),
		'type'        => 'select',
		'settings'    => 'featured_category_five',
		'section'     => 'blog_featured_categories',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Category Five', 'bosa-portfolio-resume' ),
		'choices'     => bosa_get_post_categories(),
		'priority'	  => 100,
	));

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Category Five Image', 'bosa-portfolio-resume' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Categories', 'bosa-portfolio-resume' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'blog_projects', array(
	    'title'          => esc_html__( 'Projects', 'bosa-portfolio-resume' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 28,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Projects Section', 'bosa-portfolio-resume' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Project 1', 'bosa-portfolio-resume' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Project 2', 'bosa-portfolio-resume' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Project 3', 'bosa-portfolio-resume' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Projects', 'bosa-portfolio-resume' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'blog_fun_facts', array(
	    'title'          => esc_html__( 'Fun Facts', 'bosa-portfolio-resume' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 29,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Fun Facts Section', 'bosa-portfolio-resume' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Fact one', 'bosa-portfolio-resume' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Fact One Content', 'bosa-portfolio-resume' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Fact Two', 'bosa-portfolio-resume' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Fact Two Content', 'bosa-portfolio-resume' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Fact Three', 'bosa-portfolio-resume' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Fact Three Content', 'bosa-portfolio-resume' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Fact Four', 'bosa-portfolio-resume' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Fact Four Content', 'bosa-portfolio-resume' ),
		'type'        => 'text',
	...
	Kirki::add_field('bosa',array(
		'label'        => esc_html__( 'Disable Fun Facts', 'bosa-portfolio-resume' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Product Title Typography', 'bosa-portfolio-resume' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Product Price Typography', 'bosa-portfolio-resume' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Add to Cart Button Typography', 'bosa-portfolio-resume' ),
		'type'         => 'typography',
